    		    ...
    		    var rhist = 0;
      			...
      			for(var a = 0; a<data.length; a++){
      		    	...
      		    	if(data[a].lsn_cd >= 5 && data[a].lsn_cd <= 27 && data[a].lsn_cd != 6 && data[a].lsn_cd != 7 && data[a].lsn_cd != 8 && data[a].lsn_cd != 9 ){
      		    		...
      		    		tble += '<td style="background-color: #f0f0f0;">'+data[a].lsn_nm;+'탐</td>';
      		    		tam.push(a)
                    ...
                    <div class="iq-card" style="width: 97%; height: 900px; margin-bottom: 10px;" >
                     <div class="iq-card-body" style="width: 100%; height: 100%;" >
                        <div class="iq-todo-page" style="height: 100%;">
                           ...
                           <form class="position-relative" name="searchform" id="searchform" action="BSTOR_RC_ADM_MOCK.ai">
                              ...
                              <div style="padding-top: 10px; padding-bottom: 10px; height: 50px;" align="left">
                                 ...
                                 <select name="searchtype" id="searchtype" onchange="exchg()">
                                    <c:forEach items="${EXAMList}" var="mock">
                                    	<option value="${mock.EXAM_CD}">${mock.EXAM_NM}</option>
                                    </c:forEach>
                                  </select>
                           ...
                           <table class="table table-bordered table-responsive-md text-center" style="width: 100%">
                            ...
                            <c:forEach items="${BSTORList}" var="bs"> 
                            	<tr class="mock" id="${bs.BSTOR_NM}" onclick="sele('${bs.BSTOR_NM}')">
                                 <td>${bs.BSTOR_NM}</td>
                                 <td>${bs.WARN_CNT}</td>
                               </tr>
                            </c:forEach>   

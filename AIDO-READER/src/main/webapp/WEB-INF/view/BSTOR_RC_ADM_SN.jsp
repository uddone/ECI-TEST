...
<script src="js/jquery.min.js"></script>
      ...
      $(document).ready(function() {
          ...
          $("#searchtype").val("${examcd2}").prop("selected", true);
      })
         ...
         function drawtable(data){
        	 var tble = "";
        		...
        		// console.log(BSTOR_CD)
        		    ...
        		    tble += '<div align="right" style="height : 50px;"><div class="row"><div style="width: 50%">글 갯수 ';
         ...
         function drawocr(data){
             ...
             var tble = ""
      		    ...
      		    for(var a = 0; a<data.length; a++){
      		    	if(data[a].lsn_cd >= 11 || data[a].lsn_cd == 5){
      		    		if(data[a].lsn_cd <= 19){
      		    			tble +='사회탐구 영역</td><td style="background-color: #f0f0f0;">제2외국어/한문 영역</td></tr>';
      		    			break;	
      		    		}
      		    	}
      		    	if(data[a].lsn_cd >= 20 || data[a].lsn_cd >= 10){
      		    		if(data[a].lsn_cd <= 27){
    		    ...
    		    var rhist = 0;
      			...
      			for(var a = 0; a<data.length; a++){
      		    	...
      		    	if(data[a].lsn_cd >= 5 && data[a].lsn_cd <= 27 && data[a].lsn_cd != 6 && data[a].lsn_cd != 7 && data[a].lsn_cd != 8 && data[a].lsn_cd != 9 ){
      		    		// console.log(data[a].lsn_nm)
      		    		tble += '<td style="background-color: #f0f0f0;">'+data[a].lsn_nm;+'</td>';
      		    		//tble += '<td style="background-color: #f0f0f0;">test</td>';
      		    		
      		    		// console.log("탐구"+data[a].lsn_nm)
      		    		tam.push(a)
...
/*
            ...
            function ocredit(){
                ...
                var jsonData = JSON.stringify(ocrdata);
                jQuery.ajaxSettings.traditional = true;
                formData.append("ocrdata",jsonData);    
...
<div id="content-page" class="content-page">
            <div class="container-fluid">
                    ...
                    <div align="left" style="padding-left: 10px; width: 100%; height: 30px; margin-bottom: 10px;">
                     ...
                     <div class="iq-card-body" style="width: 100%; height: 100%;" >
                        <div class="iq-todo-page" style="height: 100%;">
                           ...
                           <form class="position-relative" name="searchform" id="searchform" action="BSTOR_RC_ADM_SN.ai">
                              <div class="form-group mb-0" style="height: 50px;">
                                  <table style="border: none; width: 100%;"  >
                                   		<tr style="border: none; width: 100%;">
                                   	 		<th style="border: none; width: 60%;" >
                                   	 			<input type="hidden" name="pageNum" value="${param.pageNum }">
                                     			<input type="text" class="form-control todo-search" placeholder="검색어를 입력하세요"  name="searchcontent"
                                                       value="${param.searchcontent }" style=" margin-right: 20px;">
                                   	 		</th>
                              ...
                              <div style="margin-top: 20px; padding-bottom: 10px; height: 50px;" align="left">
                                 <h5>수능 선택<span>
               ...
               <div style="width: 28%; height: 100%; margin-left: 20px;">
                  <div class="iq-card iq-border-radius-20" style="height: 100%; padding-top: 10px; " align="center">
                     <div align="left" style="padding-left: 10px; width: 100%; height: 30px; margin-bottom: 10px;">
                         <div class="row">
                              ...
                              <div class="form-group mb-0" style="height: 50px;">
                                 <table style="border: none; width: 100%;"  >
                                   		<tr style="border: none; width: 100%;">
                                   	 		...
                                   	 		<th style="border: none; width: 15%; padding-top: 15px; padding-left: 10px;">

                                ...
                                <div class="iq-card" style="width: 95%; height: 900px;" >
                                    <div class="iq-card-body" style="width: 100%; height: 100%;" >
                                        <div class="iq-todo-page" style="height: 100%;">
                                            <form class="position-relative" name="searchform" id="searchform" action="BSTOR_RC_REG_IR.ai" method="post">
                                                ...
                                                <div style="height: 750px;" class="no-wrap">
                                                    <table class="table table-bordered table-responsive-md text-center" style="width: 100%">
                                                        ...
                                                        <tbody><c:forEach items="${EXAMList}" var="ex"><tr id ="${ex.EXAM_CD}" class="sub" onclick="disp_div('${ex.EXAM_CD}')">
                                                            <td>${ex.EXAM_KIND}</td>
                                                            <td>${ex.EXAM_NM}</td>
                                                            <td>${ex.SCHYR}</td>
                                                        </tr></c:forEach></table>
                                                ...
                                                <div align="right" style="height: 50px;">
                                                    <div class="row">
                                                        <div style="width: 40%">한 화면에 볼 글 갯수<span>
                                                            <script type="text/javascript">

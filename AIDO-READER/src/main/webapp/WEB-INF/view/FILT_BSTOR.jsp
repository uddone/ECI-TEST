...
var pageno = 1;
	...
	$(document).ready(function() {
		if("${param.limit}" != "" && "${param.limit}" != 5){
		  	...
		  	$("#limit").val("40").prop("selected", true);
		  }
	})
	...
	function kind(){
		bstr = "(";
		 $('input:checkbox[name="chk"]').each(function() {
			...
			bstr+=")"
			console.log(bstr)
		$("th[name=sbstor]",opener.document).attr("id",bstr);
            ...
            <div class="iq-card" style="width: 100%; height: 100%;" >
                  <div class="iq-card-body" style="width: 100%; height: 100%;" >
                        <div class="iq-todo-page" style="height: 100%;">
                        	<form class="position-relative" name="searchform" id="searchform" action="FILT_BSTOR.ai" method="post">
                                    ...
                                    <div class="namelist no-wrap" style="width: 95%; height: 100%;">
                                    	<table class="table" style="width: 100%;">
                                    		...
                                    		<c:forEach var="bst" items="${blist}">
                                    			<tr style="width: 100%;">
                                    				<td style="width: 50%;"><input type="checkbox" id="${bst.BSTOR_CD}" name="chk" checked="checked"></td>
                                    				<td style="width: 50%;">${bst.BSTOR_NM}</td>
                                    			</tr>
                                    		</c:forEach>
                                    	</table>
                                    </div>      

	...
	function kind(){
		bstr = "(";
		 $('input:checkbox[name="chk"]').each(function() {
			...
			bstr+=")"
			console.log(bstr)
		$("th[name=smock]",opener.document).attr("id",bstr);
            ...
            <div class="iq-card" style="width: 100%; height: 100%;" >
                  <div class="iq-card-body" style="width: 100%; height: 100%;" >
                        <div class="iq-todo-page" style="height: 100%;">
                        	<form class="position-relative" name="searchform" id="searchform" action="FILT_MOCK.ai" method="post">
                              ...
                              <div style="width: 95%; height: 45%;">
                                    <div class="namelist no-wrap" style="width: 95%; height: 100%;">
                                    	<table class="table" style="width: 100%;">
                                    		...
                                    		<th style="width: 50%;">모의고사 명</th> 
                                    		</tr>
                                    		<c:forEach var="exam" items="${examlist}">
                                    			<tr style="width: 100%;">
                                    				<td style="width: 50%;"><input type="checkbox" id="${exam.EXAM_CD}" name="chk" checked="checked"></td>
                                    				<td style="width: 50%;">${exam.EXAM_NM}</td>
                                    			</tr>
                                    		</c:forEach>
                                    	</table>
                                    </div>      

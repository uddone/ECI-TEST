	...
	function kind(){
		bstr = "";
		 $('input:checkbox[name="chk"]').each(function() {
			...
			console.log(bstr)
		$("th[name=sscore]",opener.document).attr("id",bstr);
            ...
            <div class="iq-card" style="width: 100%; height: 100%;" >
                  <div class="iq-card-body" style="width: 100%; height: 100%;" >
                        <div class="iq-todo-page" style="height: 100%;">
                        	<form class="position-relative" name="searchform" id="searchform" action="FILT_SCORE.ai" method="post">
                                <div style="width: 95%; height: 45%;">
                                    <div class="namelist no-wrap" style="width: 95%; height: 100%;">
                                    	<table class="table" style="width: 100%;">
                                    		...
                                    		<tr style="width: 100%;">
                                    				<td style="width: 50%;"><input type="checkbox" id="NOT" name="chk" checked="checked"></td>
                                    				<td style="width: 50%;">채점 안 된 시험 보기</td>
                                    		</tr>
                                    		<tr style="width: 100%;">
                                    				<td style="width: 50%;"><input type="checkbox" id="EQ" name="chk" checked="checked"></td>
                                    				<td style="width: 50%;">채점 된 시험 보기</td>
                                    		</tr>

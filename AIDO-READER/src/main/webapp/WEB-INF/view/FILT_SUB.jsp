	...
	function kind(){
		bstr = "(";
		 $('input:checkbox[name="chk"]').each(function() {
			...
			bstr+=")"
			console.log(bstr)
		$("th[name=ssub]",opener.document).attr("id",bstr);
        ...
        <div class="iq-card" style="width: 100%; height: 100%;" >
            <div class="iq-card-body" style="width: 100%; height: 100%;" >
                <div class="iq-todo-page" style="height: 100%;">
                    <form class="position-relative" name="searchform" id="searchform" action="FILT_SUB.ai" method="post">
                        ...
                        <div style="width: 95%; height: 45%;">
                            <div class="namelist no-wrap" style="width: 95%; height: 100%;">
                                <table class="table" style="width: 100%;">
                                    ...
                                    <tr style="width: 100%;">
                                        <td style="width: 50%;"><input type="checkbox" id="선택과목없음" name="chk" checked="checked"></td>
                                        <td style="width: 50%;">선택과목없음</td>
                                    </tr>
                                    <c:forEach var="bst" items="${blist}"><tr style="width: 100%;">
                                        <td style="width: 50%;"><input type="checkbox" id="${bst.SUB_NM}" name="chk" checked="checked"></td>
                                        <td style="width: 50%;">${bst.SUB_NM}</td>
                                    </tr></c:forEach>
                                </table>
                            </div>
                        </div>
